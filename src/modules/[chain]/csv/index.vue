    ...
    <div class="mx-6 section">
      <div class="flex flex-col gap-2 mb-8 pb-4 border-b border-base-400">
        ...
        <p class="md:w-2/3 text-sm text-gray-500 font-medium">
          Available message types for download include: Send, Receive, IBC Send,
          IBC Receive, Multi Send, Delegate, Undelegate, Redelegate, Reward and
          Commission.
        </p>
      ...
      <div class="space-y-6">
        ...
        >
          <div class="flex items-start gap-3">
            ...
            <div class="flex-1">
              <h3
                class="text-lg font-medium text-green-800 dark:text-green-300"
              >
                Success
              </h3>
              <p class="mt-1 text-sm text-green-700 dark:text-green-400">
                Click download for the CSV file or copy the link to share or
                redownload.
              </p>
            </div>
            ...
            <!-- Close Button -->
            <button
              @click="showSuccessSection = false"
        ...
        <div class="flex flex-col md:flex-row gap-3 mt-6">
          <button
            @click="downloadCSV"
            :disabled="isDownloading || !isValidAddress"
