...
<template>
     <div class="mx-6 section">
        ...
        <div class="space-y-6">
            ...
            <!-- Success Section -->
            <div v-if="showSuccessSection" class="mt-6 p-4 border border-green-500 rounded-lg bg-green-50 dark:bg-green-900/20">
            ...
            <!-- Error Section -->
            <div v-if="showErrorSection" class="mt-6 p-4 border border-red-500 rounded-lg bg-red-50 dark:bg-red-900/20">
                <div class="flex items-start gap-3">
                    <div class="flex-shrink-0 w-5 h-5 mt-1">
